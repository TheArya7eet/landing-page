        ...
        <header className={`sticky top-0 z-50 transition-shadow ${
            ...
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
                    ...
                    <a className="mr-5 sm:p-2 hover:text-black hover:bg-gray-300 rounded-lg cursor-pointer">About</a>
                    <a className="mr-5 sm:p-2 hover:text-black  hover:bg-gray-300 rounded-lg cursor-pointer">Projects</a>
                    <a className="mr-5 sm:p-2 hover:text-black hover:bg-gray-300 rounded-lg cursor-pointer">Contact</a>
                </nav>
