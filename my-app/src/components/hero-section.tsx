    ...
    return (
        <section className="text-gray-400  body-font">
            <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col lg:flex-row">
                <img className="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center text-center rounded-xl" alt="Error: Cannot load image" src= "" />
                    <div className="text-center lg:w-2/3 w-full">
                        <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-black">Hello, I'm Aryajeet.</h1>
