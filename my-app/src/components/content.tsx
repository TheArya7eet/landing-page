    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
          <h1 className="sm:text-3xl text-2xl font-extrabold title-font mb-2 text-gray-900">About Me</h1>
          <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">My name is Aryajeet Ghosh.
          ...
          <div className="flex space-x-5 mt-5">
            <div className="flex flex-col">
              <span className="text-2xl font-extrabold">2020</span>
              <span className="">Completed schooling from Holy Child School</span>

            </div>
            <div className="flex flex-col">
              <span className="text-2xl font-extrabold">2024</span>
              <span className="">Graduated from Haldia Institute of Technology</span>
            </div>
          </div>

          <div className="bg-indigo-500 hover:bg-indigo-600 hover:cursor-pointer mt-4 p-4 rounded-lg">
